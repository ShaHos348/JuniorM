...
router.get("/daily/:date&:shift", (req, res) => {
  ...
  // TODO: Only select the latest one.
  query =
...
/**
 * HTTP Request to update daily report.
 */
// TODO: Rather than deleting report and adding updated, change query to update.
router.post("/update", (req, res) => {
  ...
  connection.query(
    ...
    (err, results) => {
      if (!err) {
        // Inserts updated report to database again.
        part1 = businessidnum + ",'" + data.date + "','" + data.shift + "'";
