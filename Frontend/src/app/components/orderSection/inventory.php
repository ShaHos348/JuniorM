    ...
    <div class="row">
      <div class="columnl" style="background-color:#aaa;">
        ...
        <form method="POST">
          ...
          <td><input type="text" name="code" id="code" value="" placeholder=" Bar code" autofocus required />
            <p>
          <td><input type="text" name="quntity" id="quntit" value="" placeholder="quntit" autofocus required />
            <p>
