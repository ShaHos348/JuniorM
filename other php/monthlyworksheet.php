...
if(!$conn){
 ...
 $sql1 = "INSERT INTO worksheettmp (shreport1,shreport2,shreport3,shreport4,shreport6,shcount1,shcount2,shcount3,shcount4) SELECT sum(shreport1+shreport2+shreport3),sum(shreport4),sum(shreport6+shreport7),sum(shreport8+shreport9+shreport10+shreport11),sum(shreport1+shreport2+shreport3+shreport4+shreport5+shreport6+shreport7+shreport8+shreport9+shreport10+shreport11),sum(shcount1),sum(shcount2),sum(shcount3),sum(shcount4) FROM worksheet where month='$ma' "; 
    if(!mysqli_query($conn,$sql1 )) {
        die('Error: ' . mysqli_error($conn));
	}
	//$sqlu = "update worksheettmp,paidout2 set worksheettmp.cname1=paidout2.cname1,worksheettmp.cname2=paidout2.cname2,worksheettmp.cname3=paidout2.cname3,worksheettmp.cname4=paidout2.cname4,worksheettmp.cname5=paidout2.cname5 where paidout2.month='$ma'"; 
    //if(!mysqli_query($conn, $sqlu)) {
      // die('Error: ' . mysqli_error($conn));
    //}
//$sqlu = "update worksheettmp,paidout2 set worksheettmp.amount1=sum(paidout2.amount1),worksheettmp.amount2=sum(paidout2.amount2),worksheettmp.amount3=sum(paidout2.amount3),worksheettmp.amount4=sum(paidout2.amount4),worksheettmp.amount5=sum(paidout2.amount5) where paidout2.month='$ma'"; 
  //  if(!mysqli_query($conn, $sqlu)) {
    //   die('Error: ' . mysqli_error($conn));
    //}

$sqla = "update worksheettmp,paidout2 set worksheettmp.shcount5=(paidout2.amount1+paidout2.amount2+paidout2.amount3+paidout2.amount4+paidout2.amount5) where paidout2.month='$ma'"; 
