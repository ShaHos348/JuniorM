...
<div class="cont_ba_opcitiy">
        ...
        <h2>Daily Work Sheet Report</h2>  
 
  <button class="btn_login" onclick="cambiar_login()">Daily Report</button></p>
  <a href="home.php">Back to  Home</a>
  </div>
  </div>
<div class="col_md_sign_up">
<div class="cont_ba_opcitiy">
  <h2>Monthly Work Sheet Report</h2>

  
  

  <button class="btn_sign_up" onclick="cambiar_sign_up()">Monthly Report</button>
</div>
  </div>
       </div>
...
<div class="cont_forms" >
 <form  action="dailyworksheet.php" method="POST">
...
<a href="#" onclick="ocultar_login_sign_up()" ><i class="material-icons">&#xE5C4;</i></a>
   ...
   <h2>select Date</h2>
	...
	<form action="monthlyworksheet.php" method="POST"> 
...
<a href="#" onclick="ocultar_login_sign_up()"><i class="material-icons">&#xE5C4;</i></a>
    ...
    <h2> </h2>
           ...
           <td><input type="text" name="month" id="month" value="" placeholder="Enter Month"/><p>
