...
<div class="cont_ba_opcitiy">
        ...
        <h2>Yearly Report By Month</h2>  
 
  <button class="btn_login" onclick="cambiar_login()">Monthly Report</button></p>
  <a href="frontpage.php">Back to  Home</a>
  </div>
  </div>
<div class="col_md_sign_up">
<div class="cont_ba_opcitiy">
  <h2>Monthly Analyzes</h2>

  
  

  <button class="btn_sign_up" onclick="cambiar_sign_up()">Analyzes</button>
</div>
  </div>
       </div>
...
<div class="cont_forms" >
 <form  action="earlyreport.php" method="POST">
...
<a href="#" onclick="ocultar_login_sign_up()" ><i class="material-icons">&#xE5C4;</i></a>
   ...
   <h2>Select Year</h2>
           ...
           <td><input type="text" name="year" id="year" value="" placeholder="Enter Year"/><p>
	...
	<form action="monthlyworksheetanalyzes.php" method="POST"> 
