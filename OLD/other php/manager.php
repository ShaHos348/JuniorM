...
<div class="row">
  <div class="column" style="background-color:#aaa;">
    <h2>Employee</h2>
	<a href="Employee.php"><img class="mySlides" src="images/employee1.jpg" style="width:80%" height="80"></a></p>
	<a href="message_m.php"><img class="mySlides" src="images/message.jpg" style="width:80%" height="80"></a></p>
